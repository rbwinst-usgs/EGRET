...
estSurfaces<-function(eList, GetWeights, ApplyWeights, windowY=7,windowQ=2,windowS=0.5,
  ...
  resultSurvReg<-runSurvReg(estPtYear,estPtLogQ,numDays,DecLow,DecHigh,localSampleMin, GetWeights, ApplyWeights,
